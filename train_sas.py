...
from sas.datamodules import WaymoSimDataModule
from sas.datasets import WaymoSimDataset
from sas.simulators import SlimAgentSimulator
...
if __name__ == '__main__':
    ...
    SlimAgentSimulator.add_model_specific_args(parser)
    args = parser.parse_args()
    print(args)

    if args.mode == 'train':
        model = SlimAgentSimulator(**vars(args))
        ...
        model = SlimAgentSimulator.load_from_checkpoint(
