...
from sas.transforms import SimAgentFilter, SimTargetBuilder
...
class WaymoSimDataModule(pl.LightningDataModule):
    ...
    def __init__(self,
        ...
        self.train_transform = Compose([SimAgentFilter(128, 11), SimTargetBuilder()])
        self.val_transform = Compose([SimTargetBuilder()])

    def prepare_data(self) -> None:
        if not os.getenv("DEVELOPMENT", False):
