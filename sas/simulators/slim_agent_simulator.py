...
from sas.losses import MixtureNLLLoss
from sas.losses import NLLLoss
from sas.modules import SASDecoder
from sas.modules import SASHead
from sas.utils import unbatch
...
class SlimAgentSimulator(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        parser = parent_parser.add_argument_group('SAS')
